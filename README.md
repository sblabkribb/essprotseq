...
```
Seongbo Heo et al. "Protein Embedding-based Prediction of Bacterial Essential Genes Outperforms Multi-data-based Methods" Synthetic Biology Research Center, KRIBB.
```
